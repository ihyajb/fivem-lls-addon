...
---@param ped Ped
---@param weaponHash Hash | string
---@param camoComponentHash Hash | string
---@return integer
...
---@param z number
---@param radius number
---@return boolean, integer SphereIndex
