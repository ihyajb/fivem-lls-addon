...
---```
---@param ped Ped
---@return integer, number distanceRemaining, boolean isPathReady
...
---@param y number
---@param z number
---@param iGunTaskType Hash | string
---@param bDisableBlockingClip boolean
...
---@param p9 number
---@param p10 number
---@return any p1, any p2, any p3, any p4
