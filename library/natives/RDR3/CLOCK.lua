...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xAB7C251C7701D336)  
---This native does not have an official description.
---@param hours integer
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0184750AE88D0B1D)  
---This native does not have an official description.
---@param hour integer
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDF2FD796C54480A5)  
---This native does not have an official description.
---@return integer
function GetClockDayOfMonth() end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4DD02D4C7FB30076)  
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC82CF208C2B19199)  
---Gets the current ingame hour, expressed without zeros. (09:34 will be represented as 9)
---@return integer
function GetClockHours() end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4E162231B823DBBF)  
---Gets the current ingame clock minute.
---@return integer
function GetClockMinutes() end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2D44E8FC79EAB1AC)  
---This native does not have an official description.
---@return integer
function GetClockMonth() end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB6101ABE62B5F080)  
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE136DCA28C4A48BA)  
---This native does not have an official description.
---@return integer
function GetClockYear() end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE4CB8D126501EC52)  
---This native does not have an official description.
---@return integer
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x78FD8BE812E436B2)  
---Base year is 1898.
---@return integer
function GetSecondsSinceBaseYear() end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4D1A590C92BF377E)  
---This native does not have an official description.
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x568D998A9FF96774)  
---This native does not have an official description.
---@param toggle boolean
function PauseClockThisFrame(toggle) end

---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x02AD3092562941E2)  
---This native does not have an official description.
---@param day integer
---@param month integer
---@param year integer
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3A52C59FFB2DEED8)  
...
---**`CLOCK` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x04EEDB3848DACF68)  
---This native does not have an official description.
---@param ms integer
