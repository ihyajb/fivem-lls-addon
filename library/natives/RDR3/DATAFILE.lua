...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x151DAFE6B3B9888F)  
---Types:
---1 = Boolean
---2 = Integer
---3 = Float
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x92E11E3CA4C7CDF0)  
---Types:
---1 = Boolean
---2 = Integer
---3 = Float
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x26FDF5E99AA2F3E9)  
---This native does not have an official description.
---@param key string
---@param value integer
---@return any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x56B7291FB953DD51)  
---This native does not have an official description.
---@param index integer
function DatafileCreate(index) end

---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9FB90EEDEA9F2D5C)  
---This native does not have an official description.
---@param index integer
function DatafileDelete(index) end

---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x604B8ED1A482F9DF)  
---This native does not have an official description.
---@param p0 any
---@return boolean
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBBD8CF823CAE557C)  
---This native does not have an official description.
---@param index integer
---@return any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x17279C820464CEE0)  
---This native does not have an official description.
---@param p0 any
---@return boolean
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE60100389E50EADE)  
---This native does not have an official description.
---@param p0 any
---@return boolean
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x46102A0989AD80B5)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return boolean
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x790EC421078F5C4E)  
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA5834834CA8FD7FC)  
---Adds the given request ID to the watch list.
---@param id integer
function DatafileWatchRequestId(id) end

---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1C65CC931C0F946F)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x277251C161B4C3F4)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3168BA5D6DECE323)  
---nullsub, doesn't do anything
function N_0x3168ba5d6dece323() end

---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4F9E3ED7617123AC)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7681B677400C7071)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9F130129EBC31B34)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBC0DF006A4952C68)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCA56DD6AB7A39F64)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE13634BB6BAF0734)  
---This native does not have an official description.
---@param p0 integer
---@param p1 integer
---@return integer
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6BEB168D5195E7AB)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x603AC35FD4602C76)  
---This native does not have an official description.
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7907969497EA92F5)  
---This native does not have an official description.
---@param fileHandle integer
---@return boolean
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xAE156A747C39A741)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDF01B1F7A886B42D)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x129567F0C05F81B9)  
---This native does not have an official description.
---@param fileHandle integer
function ParseddataUnloadFile(fileHandle) end

---**`DATAFILE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE79C70E77E0973C7)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
