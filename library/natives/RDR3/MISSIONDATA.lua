...
---**`MISSIONDATA` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8C32D86E9556ED86)  
---This native does not have an official description.
---@param p0 any
---@return integer
...
---**`MISSIONDATA` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE54DC27571D5EDC5)  
---This native does not have an official description.
---@param p0 any
---@return boolean
...
---**`MISSIONDATA` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE824CE7D13FCB300)  
...
---**`MISSIONDATA` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7F89E15A8FB8DE97)  
---This native does not have an official description.
function MissiondataTimecycleBoxDelete() end

---**`MISSIONDATA` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7E8F86A4FA33033C)  
---This native does not have an official description.
---@return boolean
function MissiondataTimecycleBoxExists() end

---**`MISSIONDATA` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x25855B1574BF8CD5)  
---This native does not have an official description.
