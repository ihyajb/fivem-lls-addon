...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4E4ACAE1C671A9DA)  
...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6FC24625E4FCAC27)  
---This native does not have an official description.
---@param compendiumEntry integer
---@return boolean
...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBCF569FC32FFF456)  
---This native does not have an official description.
---@param compendiumEntry integer
---@return boolean
...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x67F35C7C9F2BDCFE)  
---This native does not have an official description.
---@param compendiumEntry integer
...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x725D52F21A5E9E04)  
---This native does not have an official description.
---@param p0 any
function CompendiumGangAmbushSurvived(p0) end

---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x725D52F21A5E9E06)  
---This native does not have an official description.
---@param p0 any
function CompendiumGangBountyCaptured(p0) end

---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x725D52F21A5E9E03)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x725D52F21A5E9E05)  
---This native does not have an official description.
---@param p0 any
function CompendiumGangEncountered(p0) end

---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x725D52F21A5E9E08)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPENDIUM` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x725D52F21A5E9E07)  
---This native does not have an official description.
---@param p0 any
