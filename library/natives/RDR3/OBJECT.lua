...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE2B3B852B537C398)  
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB8F5062070BB6DBD)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xBFA48E2FF417213F)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6BAB9442830C7F53)  
---Door lock states:
---enum eDoorState
---{
---	DOORSTATE_INVALID = -1,
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x758A5C1B3B1E1990)  
---This native does not have an official description.
---@param p0 any
...
---**`OBJECT` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE143FA2249364369)  
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x163E252DE035A133)  
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB48FCED898292E52)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6E16BC2503FF1FF0)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x761B0E69AC4D007E)  
---This native does not have an official description.
---@param p0 number
---@param p1 number
---@param p2 number
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8ABFB70C49CC43E2)  
---This native does not have an official description.
---@param p0 any
---@return boolean
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2A70BAE8883E4C81)  
---This native does not have an official description.
---@param p0 number
---@param p1 number
---@param p2 number
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x08C5825A2932EA7B)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1F5E07E14A86FAFC)  
---_SET_A(MBIENT_PICKUP_?)*
---@param p0 boolean
function N_0x1f5e07e14a86fafc(p0) end

---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x22031584496CFB70)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x235C863DA77BD88D)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x250EBB11E81A10BE)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2BF1953C0C21AC88)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3A77DAE8B4FD7586)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3E2616E7EA539480)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x46CBCF0E98A4E156)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x491439AEF410A2FC)  
---This native does not have an official description.
---@param p0 any
function N_0x491439aef410a2fc(p0) end

---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x4AE07EBA3462C5D5)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6579860A5558524A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCEAB54F4632C6EF6)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD91E55B6C005EB09)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDE116ECFFDD4B997)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDFA1237F5228263F)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF6E88489B4E6EBE5)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xFA99E8E575F2FEF8)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xAC9AE68F0A463752)  
---This native does not have an official description.
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x78857FC65CADB909)  
---This native does not have an official description.
---@param toggle boolean
function SetLocalPlayerCanCollectPortablePickups(toggle) end

---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x88EAEC617CD26926)  
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x971DA0055324D033)  
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x318516E02DE3ECE2)  
---This native does not have an official description.
---@param multiplier number
function SetPickupGenerationRangeMultiplier(multiplier) end

---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x81218CE01B672219)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x92E87F60F21A0C3A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1607C7D9B3021DF5)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xEB9740A38FD6D634)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x4A8CB328CD6F1C9B)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`OBJECT` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF92099527DB8E2A7)  
---This native does not have an official description.
