...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x754616EC6965D1FB)  
---Must be called every frame to take full effect.
function DisableWaterLookup() end

---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x754616EC6965D1BF)  
---This native does not have an official description.
function EnableWaterLookup() end

---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFCA8B23F28813F69)  
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDCF3690AA262C03F)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x189739A7631C1867)  
---This native does not have an official description.
---@return integer
function GetWorldWaterType() end

---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x09A1C7DFDCE54FBC)  
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA33F5069B0CB89B8)  
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE8126623008372AA)  
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4BEF8DD75AF6C71C)  
---Only used in rcm_crackpot1 R* Script: p0 = 0
---@param index integer
function RemoveExtraCalmingQuad(index) end

---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC63540AEF8384769)  
---Only used in guama1 / guama3 R* Script
---_REQUEST_* or _RESET_*
function ResetGuarmaWaterState() end

---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC63540AEF8384732)  
...
---@param p1 number
---@param waveDirection integer
---@param p3 number
---@param waveAmmount number
---@param p5 number
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8974647ED222EA5F)  
...
---**`WATER` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2B3451FA1E3142E2)  
