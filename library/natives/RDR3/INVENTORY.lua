...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0FBBFFC891A97C81)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC04F47D488EF9EBA)  
---This native does not have an official description.
---@param inventoryId integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x644CCB76A76CFBD6)  
---This native does not have an official description.
---@param p0 boolean
---@param p1 boolean
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x80D78BDC9D88EF07)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBB7F968675B34B0C)  
---p1: 32
---Returns collectionId
---@param inventoryId integer
---@param p1 integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE1F389F03DC83673)  
---This native does not have an official description.
function InventoryDisableMissionInventoryPickups() end

---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE3A46370F70F3607)  
---Params: p1 = 0
---@param inventoryId integer
---@param p1 any
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD5D72F1624F3BA7C)  
---This native does not have an official description.
---@param inventoryId integer
function InventoryEnableWeapons(inventoryId) end

---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x734311E2852760D0)  
---This native does not have an official description.
---@param inventoryId integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x025A1B1FB03FBF61)  
---This native does not have an official description.
---@param inventoryId integer
---@param p3 integer
---@param p4 integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x13D234A2A3F66E63)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9700E8EFC4AB9089)  
---This native does not have an official description.
---@param inventoryId integer
---@param p3 boolean
---@return boolean, any, any
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCD9A485F2B383B44)  
---This native does not have an official description.
---@param inventoryId integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC97E0D2302382211)  
---This native does not have an official description.
---@param inventoryId integer
---@param p2 boolean
---@return integer, any
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x82FA24C3D3FCD9B7)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFC7563F482781A3D)  
---This native does not have an official description.
---@return boolean
function InventoryIsPlayerInventoryMirroringTransactions() end

---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7C7E4AB748EA3B07)  
---old name _INVENTORY_USE_SP_BACKUP
---@return boolean
function InventoryIsUsingBackupInventory() end

---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDCCAA7C3BFD88862)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x42A2F33A1942E865)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5D6182F3BCE1333B)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3E4E811480B3AE79)  
---This native does not have an official description.
---@param inventoryId integer
---@param quantity integer
---@param removeReason integer | string
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9A113C660AEA3832)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD740F11FBC8AEF43)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x227522FD59DDB7E8)  
---This native does not have an official description.
---@param inventoryId integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x65A5F70F4A292EBE)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6D2F987736A42D4C)  
---OWE_INVALID = -1,
---OWE_GOOD_IN_HOT
---OWE_GOOD_IN_NONE
---OWE_GOOD_IN_COLD
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD80A8854DB5CFBA5)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE36D4A38D28D9CFB)  
---Only used in R* SP Scripts
---@param p0 boolean
function InventoryUseBackupInventory(p0) end

---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA6AA9F56BC6CFF58)  
---This native does not have an official description.
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x46743BBFEDBC859E)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0349404A22736740)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6968CE7AC32F6788)  
---Only used in R* SP Scripts
---@param inventoryId integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9B4E793B1CB6550A)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD08685BA892DBFAB)  
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE1F45A67A9F0DCBC)  
---Only used in R* SP Scripts
---@param inventoryId integer
...
---**`INVENTORY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x597F571DDEE3FFAC)  
