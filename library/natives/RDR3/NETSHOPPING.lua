...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD1CE92D1D9BE170A)  
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6CE9FB6332B5E46E)  
---This native does not have an official description.
---@return boolean
function CashinventoryIsConnectionFaulted() end

---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xFCC24220FDDAC929)  
---This native does not have an official description.
---@return boolean
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x592BC00BF6629BE7)  
---This native does not have an official description.
---@param id integer
---@return boolean
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x59EF5D516E2D96B9)  
---This native does not have an official description.
---@param id integer
---@return boolean
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x52A226ADF4A270D2)  
---This native does not have an official description.
---@param id integer
---@return boolean
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7616B5F0895C2D99)  
---This native does not have an official description.
---@param id integer
---@param index integer
---@return boolean, any
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCF2D04D076847478)  
---This native does not have an official description.
---@param id integer
---@return integer
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x98412398BBE73F61)  
---This native does not have an official description.
---@param id integer
---@param index integer
---@return boolean, any
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x38640A8C2DEF011B)  
---This native does not have an official description.
---@param p0 integer
---@return integer
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x92A32BA29622763F)  
---This native does not have an official description.
---@param id integer
---@param index integer
---@return boolean, any
...
---**`NETSHOPPING` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB6F4557060EF0FB4)  
---This native does not have an official description.
---@param p0 integer
---@param p1 integer
---@return integer
