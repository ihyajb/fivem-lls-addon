...
---@param vehicle Vehicle
---@param lightPropset Hash | string
...
---**`PROPSET` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC4B67EF3FD65622D)  
