...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0FD07141AD048AAE)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6D85126F6CCF02C9)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB7223B91CD6B7E07)  
---This native does not have an official description.
---@param feedChannel integer
---@return boolean
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6035E8FBCA32AC5E)  
---Hides Toast Notifications
function UiFeedClearAllChannels() end

---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDD1232B332CBB9E7)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2F901291EF177B02)  
---Clears help text
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC17F69E1418CD11F)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x59FA676177DBE4C9)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xAFF5BE9BA496CE40)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x18D6869FBFFEC0F8)  
---notification you need dataview
---@param p2 boolean
---@param p3 boolean
---@return integer, any, any
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD05590C1AB38F068)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3F9FDDBA79117C69)  
---This native does not have an official description.
---@param p2 integer
---@param p3 integer
---@return integer, any, any
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC927890AA64E9661)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x26E87218390E6729)  
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x38838A646FB30AAE)  
---This native does not have an official description.
---@param p2 boolean
---@param p3 boolean
---@param p4 boolean
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x02BCC0FE9EBA3529)  
---This native does not have an official description.
---@param p2 boolean
---@param p3 boolean
---@param p4 boolean
...
---**`UIFEED` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA6F4216AB10EB08E)  
---This native does not have an official description.
---@param p2 boolean
---@param p3 boolean
---@return integer, any, any
