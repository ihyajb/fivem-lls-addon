...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x845FFC3A4FEEFA3E)  
---Old name: AUDIO_IS_SCRIPTED_MUSIC_PLAYING
---@return boolean
function AudioIsMusicPlaying() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x374F0E716BFCDE82)  
---This native does not have an official description.
---@param name string
---@param x number
---@param y number
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6378A235374B852F)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x5B17A90291133DA5)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x120C48C614909FA4)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x218DD44AAAC964FF)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x33D51F801CB16E4F)  
---This native does not have an official description.
function ClearConversationHistory() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xEF51242E35242B47)  
---This native does not have an official description.
---@param convoRoot string
function ClearConversationHistoryForScriptedConversation(convoRoot) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD2C91A0B572AAE56)  
---This native does not have an official description.
---@param convoRoot string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x72E4D1C4639BC465)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x062D5EAD4DA2FA6A)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x480357EE890C295A)  
---This native does not have an official description.
---@param p0 string
---@return integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0556C784FA056628)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE7A0D23DC414507B)  
---This native does not have an official description.
---@return integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x430386FE9BF80B45)  
---This native does not have an official description.
---@return integer
function GetSoundId() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x714A0EA7DE1167BE)  
---This native does not have an official description.
---@param audioName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x84848E1C0FC67DBB)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA2CAC9DEF0195E6F)  
---This native does not have an official description.
---@param p0 boolean
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB65B60556E2A9225)  
---This native does not have an official description.
---@param scene string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD89504D9D7D5057D)  
---This native does not have an official description.
---@param convoRoot string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDF0D54BE7A776737)  
---This native does not have an official description.
---@param convoRoot string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1ECC76792F661CF5)  
---This native does not have an official description.
---@param p0 string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF01C570E0A0A1E67)  
---This native does not have an official description.
---@param p0 string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCC9AA18DCC7084F4)  
---This native does not have an official description.
---@param p0 any
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD11FA52EB849D978)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1F1F957154EC51DF)  
---This native does not have an official description.
---@param streamName string
---@param soundSet string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x017492B2201E3428)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x06C5DF5EE444BC6B)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x078F77FD1A43EAB3)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0CB3D1919E8D7CBA)  
---This native does not have an official description.
---@param convoRoot string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0D7FD6A55FD63AEF)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0FAF7171BF613B80)  
---This native does not have an official description.
---@param p0 any
function N_0x0faf7171bf613b80(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x131EC9247E7A2903)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x138ADB94F8B90616)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x152ED1B56E8F1F50)  
---This native does not have an official description.
---@param p0 string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1E6F9A9FE1A99F36)  
---This native does not have an official description.
---@param audSpeechEvent string
function N_0x1e6f9a9fe1a99f36(audSpeechEvent) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x254B0241E964B450)  
---This native does not have an official description.
---@param p0 string
---@param currentScriptedConvoLine integer
---@return integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x259ACC5B52A2B2D9)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2651DDC0EA269073)  
---This native does not have an official description.
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x295859EB18F48D82)  
---This native does not have an official description.
---@param p0 string
---@return integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2B101AD9F651243A)  
---This native does not have an official description.
---@return any
function N_0x2b101ad9f651243a() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2B9C37C01BF25EDB)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x341CDD17EFC2472E)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x35B8C070E0C16E2F)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x380A2E353AD30917)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3A00D87B20A2A5E4)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3A3BE6B920525237)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3D0BBCCF401B5FDB)  
---This native does not have an official description.
function N_0x3d0bbccf401b5fdb() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3E93DDDCBB6111E4)  
---This native does not have an official description.
---@param p0 string
---@param p1 number
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3E98AC9D8C56C62C)  
---This native does not have an official description.
---@param p0 any
function N_0x3e98ac9d8c56c62c(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x40CA665AB9D8D505)  
---This native does not have an official description.
---@param convoRoot string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x43037ABFE214A851)  
---This native does not have an official description.
...
---@param p4 integer
function N_0x448f2647dd6f2e27(ped, hash, p2, gestureAnim, p4) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x44A5EEF54F62E823)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x569ABC36E28DDEAA)  
---This native does not have an official description.
function N_0x569abc36e28ddeaa() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x580D71DFE0088E34)  
---_IS_SOUND_RUNNING(?)
---@param audioName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x5A13586A9447931F)  
---This native does not have an official description.
---@param p0 boolean
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x5AE0CB5F35F034FD)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x5BC885EBD75FAA7D)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x5E3CCF03995388B5)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x64B956F4E761DF5C)  
---This native does not have an official description.
---@param p0 any
function N_0x64b956f4e761df5c(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x660A8F876DF1D4F8)  
---speechEventType: https://github.com/Halen84/RDR3-Native-Flags-And-Enums/tree/main/naSpeechEventType 
---SKIP_* - START_*
---@param speechEventType integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6652B0C8F3D414D0)  
---This native does not have an official description.
---@param p0 any
function N_0x6652b0c8f3d414d0(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6AB944DF68B512D3)  
---_STOP_AUDIO_*
---@param p0 any
function N_0x6ab944df68b512d3(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6B7A88A61B41E589)  
---This native does not have an official description.
---@param p0 any
function N_0x6b7a88a61b41e589(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6DA15746D5CC1A92)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7455CD705F7E933E)  
---_AUDIO_IS_* - _AUDIO_TRIGGER*
function N_0x7455cd705f7e933e() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7678FE0455ED1145)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7E176C676F8652A9)  
---This native does not have an official description.
---@param p0 any
function N_0x7e176c676f8652a9(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x821C32C728B24477)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x839C9F124BE74D94)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x847748AE5D7B1071)  
---This native does not have an official description.
---@param p0 boolean
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8D29FDF565DED9AE)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x935DBD96D4A3DA1F)  
---This native does not have an official description.
---@param p0 string
---@param currentScriptedConvoLine integer
---@return integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA2B851605748AD0E)  
---This native does not have an official description.
function N_0xa2b851605748ad0e() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA6847BBA4FCDD13F)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA6A3A3F96B8B030E)  
---This native does not have an official description.
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xC369E2234E34A0CA)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xC68C02DE259C927C)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xC886CD666ADD42E1)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCBF2BEBB468A34F3)  
---This native does not have an official description.
---@param p0 any
function N_0xcbf2bebb468a34f3(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCFAD2C8CD1054523)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD05A460328560477)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD0730C1FA40348D9)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD47D47EFBF103FB8)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD733528B6C35647A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDAD6CD07CAA4F382)  
---This native does not have an official description.
function N_0xdad6cd07caa4f382() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDC2F83A0612CA34D)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDC93F0948F2C28F4)  
---This native does not have an official description.
---@param p0 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE600F61F54A444A6)  
---This native does not have an official description.
---@return any
function N_0xe600f61f54a444a6() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE7E6CB8B713ED190)  
---This native does not have an official description.
function N_0xe7e6cb8b713ed190() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xE891504B2F0E2DBA)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xEA546C31FD45F8CD)  
---This native does not have an official description.
---@param p0 any
function N_0xea546c31fd45f8cd(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xEB4D592620B8C209)  
---This native does not have an official description.
---@param p0 any
function N_0xeb4d592620b8c209(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF092B6030D6FD49C)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF0EE69F500952FA5)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF232C2C546AC16D0)  
---This native does not have an official description.
---@param p0 string
function N_0xf232c2c546ac16d0(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF336E9F989B3518F)  
---This native does not have an official description.
---@param p0 string
---@return integer
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF64034D533CE8AAC)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xFCDEC42B1C78B7F8)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xFD461D0ABA5559B1)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xFE5C6177064BD390)  
---This native does not have an official description.
---@param p0 boolean
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xFFE9C53DEEA3DB0B)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param x number
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8530AD776CD72B12)  
---This native does not have an official description.
---@param p0 string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xED640017ED337E45)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCD536C4D33DCC900)  
---This native does not have an official description.
---@param play boolean
function PlayEndCreditsMusic(play) end

---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBC9AE166038A5CEC)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8E04FEDD28D42462)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7FF4944CC209192D)  
---This native does not have an official description.
---@param audioName string
---@param audioRef string
---@param p2 boolean
...
---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCCE219C922737BFA)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF1C5310FEAA36B48)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDCF5BA95BBF0FABA)  
---Starts Audio Loop
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB18FEC133C7C6C69)  
...
---@return any
function PlaySoundFromScriptedSpeech(scriptedSpeech) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x67C540AA08E4A6F5)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCE5D0FFE83939AF1)  
---This native does not have an official description.
---@param soundId integer
---@param name string
---@param soundSet string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x21442F412E8DE56B)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x58FCE43488F9F5F4)  
---This native does not have an official description.
---@param streamId integer
function PlayStreamFrontend(streamId) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3B3CAD6166916D87)  
---This native does not have an official description.
---@param convoRoot string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1E5185B72EF5158A)  
---This native does not have an official description.
---@param eventName string
---@return boolean
...
---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE368E8422C860BA7)  
...
---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD9130842D7226045)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xC6ED9D5092438D91)  
---nullsub, doesn't do anything
---@param p0 boolean
function RegisterScriptWithAudio(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x77ED170667F50170)  
---This native does not have an official description.
---@param audioBank string
function ReleaseNamedScriptAudioBank(audioBank) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7A2D8AD0A9EB9C3F)  
---This native does not have an official description.
function ReleaseScriptAudioBank() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9D746964E0CF2C5F)  
---This native does not have an official description.
---@param soundName string
---@param soundsetName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x353FC880830B88FA)  
---This native does not have an official description.
---@param soundId integer
function ReleaseSoundId(soundId) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x531A78D6BF27014B)  
---This native does not have an official description.
---@param soundsetName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB4BBFD9CD8B3922B)  
---This native does not have an official description.
---@param p0 string
function RemovePortalSettingsOverride(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2F844A8B08D76685)  
---This native does not have an official description.
---@param audioBank string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9AEB285D1818C9AC)  
---This native does not have an official description.
---@param p0 string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9748FA4DE50CCE3E)  
---This native does not have an official description.
---@param ambientZone string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF3638DAE8C4045E1)  
---This native does not have an official description.
---@param ambientZone string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3743CE6948194349)  
---This native does not have an official description.
---@param ambientZone string
---@param x number
---@param y number
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xBDA07E5950085E46)  
---This native does not have an official description.
---@param zoneName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x1D6650420CEC9D3B)  
---This native does not have an official description.
---@param ambientZone string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xB9EFD5C25018725A)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9B1FC259187C97C0)  
---This native does not have an official description.
---@param p0 string
function SetAudioOnlineTransitionStage(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xAC84686C06184B0D)  
---This native does not have an official description.
---@param audioName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xEF21A9EF089A2668)  
---This native does not have an official description.
---@param scene string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x3BD3F52BA9B1E4E8)  
---nullsub, doesn't do anything
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8BF907833BE275DE)  
---This native does not have an official description.
---@param p0 number
---@param p1 number
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x149AEE66F0CB3A99)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x044DBAD7A7FA2BE5)  
---This native does not have an official description.
---@param p0 string
---@param p1 string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x399D2D3B33F1B8EB)  
---This native does not have an official description.
...
---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x503703EC1781B7D6)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9821B68CD3E05F2B)  
---This native does not have an official description.
---@param variableName string
---@param variableValue number
---@param audioName string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9663FE6B7A61EB00)  
---This native does not have an official description.
---@param p0 string
function SkipToNextScriptedConversationLine(p0) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x013A80FC08F6E4F2)  
---This native does not have an official description.
---@param scene string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6339C1EA3979B5F7)  
---This native does not have an official description.
---@param audioName string
---@param sceneset string
---@return boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x23641AFE870AF385)  
---This native does not have an official description.
---@param convoRoot string
function StartPreloadedConversation(convoRoot) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x6B17C62C9635D2DC)  
---This native does not have an official description.
---@param convoRoot string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2E399EAFBEEA74D5)  
---This native does not have an official description.
function StopAllScriptedAudioSounds() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x36559148B78853B3)  
---This native does not have an official description.
---@param p0 boolean
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDFE8422B3B94E688)  
---This native does not have an official description.
---@param scene string
function StopAudioScene(scene) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xBAC7FC81A75EC1A1)  
---This native does not have an official description.
function StopAudioScenes() end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9428447DED71FC7E)  
---This native does not have an official description.
---@param sceneset string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD79DEEFB53455EBA)  
---This native does not have an official description.
---@param p0 string
---@param p1 boolean
---@param p2 boolean
...
---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3210BCB36AF7621B)  
---Old Name: _STOP_SOUND_WITH_ID
---@param soundId integer
function StopSound(soundId) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0F2A2175734926D8)  
---This native does not have an official description.
---@param audioName string
---@param audioRef string
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA4718A1419D18151)  
---This native does not have an official description.
---@param streamId integer
function StopStream(streamId) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x706D57B0F50DA710)  
...
---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x87E6302FC61208CC)  
---_UNLOAD_[A-C]* - USE_*
---@param speechContext string
function UnloadSpeechContext(speechContext) end

---**`AUDIO` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA8638BE228D4751A)  
---nullsub, doesn't do anything
function UnregisterScriptWithAudio() end

---**`AUDIO` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0286617C8FC50A53)  
