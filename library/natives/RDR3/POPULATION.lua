...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xC6DCC2A3A8825C85)  
---This native does not have an official description.
---@param unk boolean
function DisableAmbientRoadPopulation(unk) end

---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xBC90BDF4E5228EA1)  
---This native does not have an official description.
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2161278C6322F740)  
---This native does not have an official description.
---@param includeFlags integer
---@param excludeFlags integer
---@param p2 integer
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x247F86595D396344)  
---This native does not have an official description.
---@param p0 any
function N_0x247f86595d396344(p0) end

---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x2660E7720EDC4BD0)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x324AB2A68AD8AEE5)  
---This native does not have an official description.
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x638FCFC6042A9473)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8EC7CD701F872F87)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xC4533E3E87125C9E)  
---This native does not have an official description.
---@param p0 any
function N_0xc4533e3e87125c9e(p0) end

---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xDBBF12EA7C1029B2)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xEC116EDB683AD479)  
...
---**`POPULATION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF45E46DEECF7DF6E)  
---This native does not have an official description.
