...
---**`BRAIN` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3F44EA613A5B2676)  
---This native does not have an official description.
---@param brainSet integer
function DisableScriptBrainSet(brainSet) end

---**`BRAIN` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1CF6E5C6750EADBD)  
---This native does not have an official description.
---@param brainSet integer
...
---**`BRAIN` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4AA5EA1EDFB25786)  
...
---**`BRAIN` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA6AC35DB4A7957A8)  
...
---**`BRAIN` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA32B0B05EFF75730)  
...
---**`BRAIN` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x74C333E34DF74E8A)  
---This native does not have an official description.
