...
---**`MISC` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3B882A96EA77D5B1)  
---Possible flag names:
---ALL_BASE = 0,
---PROJECTILES = 1,
---BROADCAST = 524288,
...
---**`MISC` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x082C043C7AFC3747)  
...
---**`MISC` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x40D72189F46D2E15)  
---disables prompt eat 
---@param compositeId integer
---@param disable boolean
...
---This native does not have an official description.
---@param transitionMode Hash | string
---@return boolean
...
---@param coords any
---@param flags integer
---@return boolean, number groundZ, Hash material, integer outFlags
...
---@param p1 boolean
---@param p2 boolean
---@param lootTableKey Hash | string
---@param p5 any
---@return any p4
...
---@return boolean, vector3 returnCoords, number returnHeading
