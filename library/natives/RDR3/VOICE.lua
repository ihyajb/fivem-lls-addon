...
---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x08797A8C03868CB8)  
---This native does not have an official description.
---@param threshold number
function N_0x08797a8c03868cb8(threshold) end

---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1C38C3577901AF1F)  
---This native does not have an official description.
function N_0x1c38c3577901af1f() end

---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1FBF7F5BA7E4BE3A)  
---This native does not have an official description.
---@param p0 integer
...
---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x58125B691F6827D5)  
---This native does not have an official description.
...
---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x79F478FF5F9F4F05)  
---This native does not have an official description.
...
---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB3E8841F6BDAF83E)  
---This native does not have an official description.
function N_0xb3e8841f6bdaf83e() end

---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB6E79850B759A30E)  
---This native does not have an official description.
...
---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB779F4FA19269AEC)  
---This native does not have an official description.
---@param flag boolean
function N_0xb779f4fa19269aec(flag) end

---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCCF71FCFA0070B1A)  
---This native does not have an official description.
---@return boolean
...
---**`VOICE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xEC8703E4536A9952)  
---This native does not have an official description.
