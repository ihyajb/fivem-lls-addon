...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCBD9EC60495C728C)  
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x72B7F65F11FC8896)  
---This native does not have an official description.
---@param groupId integer
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0A8FD91EDE7B328A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x0C6A00DAE896614C)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x61BDA07407754A5C)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x722FBE08EF5B87BD)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x7274F84B1501B523)  
---This native does not have an official description.
---@param p0 any
function N_0x7274f84b1501b523(p0) end

---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x8FB98B719AA0075A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x991E3346D788F20F)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0x9C902084F48D2E6C)  
---This native does not have an official description.
---@param p0 any
function N_0x9c902084f48d2e6c(p0) end

---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xA079FF7CFB9AC8BD)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xBF6583E926D13890)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xCE27824B5968B79A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD55A871E1CE3481B)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xD747979C053EFA7A)  
---This native does not have an official description.
---@param p0 any
function N_0xd747979c053efa7a(p0) end

---**`COMPANION` ``**  
---[Native Documentation](https://rdr3natives.com/?native=0xF06CBB8CCCA823C0)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
