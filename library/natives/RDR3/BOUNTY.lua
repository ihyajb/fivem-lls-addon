...
---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2BA1BCC99826CDA2)  
---This native does not have an official description.
function BountyCancelLegendaryMission() end

---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6A9DF0FCD0C87FF9)  
---This native does not have an official description.
function BountyCancelWantedPoster() end

---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA59D1997ECD99F0A)  
---This native does not have an official description.
function BountyClearBeingBountyHunter() end

---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x932DB3C05A7465D1)  
---This native does not have an official description.
...
---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFC81D7C7A151CFAA)  
---This native does not have an official description.
---@param p1 integer
---@param p2 integer
---@return boolean, any
...
---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x48E4E23F1739E197)  
---This native does not have an official description.
---@param p1 integer
---@param p2 integer
---@return boolean, any
...
---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD6A67E2FF373D0E3)  
---_BOUNTY_GET_*
---@param p0 integer
---@return integer
...
---**`BOUNTY` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF8BCC5ECA33AC9C1)  
---_BOUNTY_GET_*
---@return integer
