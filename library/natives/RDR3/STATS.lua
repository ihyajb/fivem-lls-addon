...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x025E98E317652CDD)  
---This native does not have an official description.
---@param p0 integer
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x218F7710A139D012)  
---This native does not have an official description.
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x378D3B1B11D9385B)  
---This native does not have an official description.
---@param p0 integer
function N_0x378d3b1b11d9385b(p0) end

---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3AEABAE3F3C7600C)  
---This native does not have an official description.
---@return boolean
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3F6FD87D2030ADC6)  
---This native does not have an official description.
---@return any
function N_0x3f6fd87d2030adc6() end

---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4DAC398297981B87)  
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4E463A3CDEFFFE96)  
---Only used in R* Script net_char_creator
function N_0x4e463a3cdefffe96() end

---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4F2D5FA23DB992DE)  
---Only used in R* Script net_char_creator
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6123E2832C34243D)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9D0F5D2E1951CD84)  
---This native does not have an official description.
---@return number
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA59590050F80FF2E)  
---Only used in R* SP Scripts
---@param p0 any
---@param p1 boolean
---@param p2 boolean
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCA41E86545413B5B)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDA26263C07CCE9C2)  
---This native does not have an official description.
---@param p0 integer
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDF95DF488A645CE7)  
---This native does not have an official description.
function N_0xdf95df488a645ce7() end

---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE141F6B40B1E3683)  
---statId: see STAT_ID_IS_VALID
---Only used in R* SP Scripts
---_STAT_ID_SET_*
---@param value number
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE5A680A5D8B1F687)  
---This native does not have an official description.
---@param p0 integer
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1E7384AB5D4F4581)  
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7C2ABF6E556B21FC)  
---This native does not have an official description.
---@param item integer
---@param slot integer
---@param p2 any
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC48FE1971C9743FF)  
---struct StatId
---{
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3B5107353267D7A1)  
---statId: see STAT_ID_IS_VALID
---@param value boolean
---@param p2 boolean
---@return boolean, any statId
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x481BDF6A10C5EF68)  
---statId: see STAT_ID_IS_VALID
---@param value number
---@param p2 boolean
---@return boolean, any statId
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x05060A54834F2382)  
---statId: see STAT_ID_IS_VALID
---@param label string
---@param p2 boolean
---@return boolean, any statId
...
---**`STATS` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA4DDF5DF95E65EEE)  
---statId: see STAT_ID_IS_VALID
---@param value integer
---@param p2 boolean
---@return boolean, any statId
