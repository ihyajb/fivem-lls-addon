...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x30996422DF1EE561)  
---Old name: _ALLOW_PAUSE_MENU_WHEN_DEAD_THIS_FRAME
function AllowPauseWhenNotInStateOfPlayThisFrame() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x823BF7B1DF613A21)  
---This native does not have an official description.
---@return boolean
function BusyspinnerIsOn() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x58F441B90EA84D06)  
---Removes the loading prompt at the bottom right of the screen.
function BusyspinnerOff() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7F78CD75CC4539E4)  
---This native does not have an official description.
---@param text string
function BusyspinnerSetText(text) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x916ED8321F087059)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x56CE42A528156A67)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC5C7A2F6567FCCBC)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD63FE3AF9FB3D53F)  
---If Hud should be displayed
---@param toggle boolean
function DisplayHud(toggle) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD79334A4BB99BAD1)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2C729F2B94CEA911)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x73C258C68D6F55B6)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x26F6BBEA2CE3E3DC)  
---Enables reduced time scale while menus such as weapon wheel and satchel are open.
function EnableReducedMenuTimeScale() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9D7E12EC6A1EE4E5)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCFEDCCAD3C5BA90D)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB39C81628EF10B42)  
---This native does not have an official description.
---@param worldX number
---@param worldY number
---@param worldZ number
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3429670F9B9EF2D3)  
---This native does not have an official description.
---@param label string
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x481FBF588B0B76DB)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDC5AD6B7AB8184F5)  
---This native does not have an official description.
---@param string string
---@return integer
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB6762A85EE29AA60)  
---This native does not have an official description.
---@param name string
---@return integer
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0501D52D24EA8934)  
...
---@param p0 integer
---@return integer
function GetNearHorse(p0) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBD5DD5EAE2B6CE14)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD8402B858F4DDD88)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBF4F34A85CA2970D)  
---This native does not have an official description.
function HideHudThisFrame() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xEA600AABAF4B9084)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x71B72B478F8189DC)  
---This native does not have an official description.
---@return boolean
function IsHudHidden() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6E1C31E14C7A5F97)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3EE32F7964C40FE6)  
---This native does not have an official description.
---@param name string
---@return boolean
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x535384D6067BA42E)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1B82FD5FFA4D666E)  
---This native does not have an official description.
---@return boolean
function IsRadarHidden() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x66F35DD9D2B58579)  
---This native does not have an official description.
---@return boolean
function IsRadarHiddenByScript() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x81E47F0EE1F2B21E)  
---This native does not have an official description.
---@return boolean
function IsRadarPreferenceSwitchedOn() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7C4AC9573587F2DF)  
---This native does not have an official description.
---@return boolean
function IsSubtitlePreferenceSwitchedOn() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCF782691D91F270E)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF402978DE6F88D6E)  
---This native does not have an official description.
function JournalClearAllProgress() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3D16ABD7A1FD8C96)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE65B5DE53351BE22)  
---This native does not have an official description.
---@return any
function JournalGetEntryCount() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5514C3E60673530F)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCB5945E1B855852F)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x62CC549B3B8EA2AA)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE4509BABE59BD24E)  
---This native does not have an official description.
---@param p0 any
function JournalMarkRead(p0) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6DFDD665E416B093)  
---This native does not have an official description.
---@param p0 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1F9A64C2804B3471)  
---This native does not have an official description.
---@param gamerTagId integer
function MpGamerTagDisableReviveTopIcon(gamerTagId) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFFF6579CF0139FCE)  
---This native does not have an official description.
---@param gamerTagId integer
function MpGamerTagEnableReviveTopIcon(gamerTagId) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x052D4AC0922AF91A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x066725A9D52B3641)  
---This native does not have an official description.
---@return any
function N_0x066725a9d52b3641() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x100157D6D7FE32CA)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x160825DADF1B04B3)  
---This native does not have an official description.
function N_0x160825dadf1b04b3() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x28AE29D909C8FDCE)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2F7BB105144ACF30)  
---nullsub, doesn't do anything
function N_0x2f7bb105144acf30() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3FE4FB41EF7D2196)  
---This native does not have an official description.
---@param p0 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x958278B97C4AFFD8)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9D37EB5003E0F2CF)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBFFF81E12A745A5F)  
---nullsub, doesn't do anything
function N_0xbfff81e12a745a5f() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD6BD313CFA41E57A)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF1E6979C0B779985)  
---This native does not have an official description.
---@param uiscene integer
function N_0xf1e6979c0b779985(uiscene) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x98AF2BB6F62BD588)  
---This native does not have an official description.
---@param name string
---@param p1 boolean
---@return boolean
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0E692EE61761361F)  
---This native does not have an official description.
---@param name string
---@return boolean
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x839BFD7D7E49FE09)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCE0D2F5586627CCE)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCE47C21C0687EBC2)  
---This native does not have an official description.
---@param active boolean
function SetFrontendActive(active) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x402669A4BDAA72DA)  
---This native does not have an official description.
---@param p0 boolean
---@param name string
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD98630CE73C61E98)  
---This native does not have an official description.
---@param p0 boolean
---@param name string
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA0D7CE5F83259663)  
---This native does not have an official description.
---@param gamerTagId integer
---@param string string
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xEA6F4B8D4B4B5B3E)  
---This native does not have an official description.
---@param gamerTagId integer
---@param string string
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1EA716E0628A6F44)  
---This native does not have an official description.
---@param gamerTagId integer
---@param text string
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xEF7AB1A0E8C86170)  
---nullsub, doesn't do anything
---@param gamerTagId integer
---@param allow boolean
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x93171DDDAB274EB8)  
---visibility:
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x50A41AD966910F03)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE550CDE128D56757)  
---This native does not have an official description.
---@param renderId integer
function SetTextRenderId(renderId) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD4EE21B7CC7FD350)  
---This native does not have an official description.
---@param state boolean
function ShowHorseCores(state) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x50C803A4CD5932C5)  
---This native does not have an official description.
---@param state boolean
function ShowPlayerCores(state) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xAA03F130A637D923)  
---This native does not have an official description.
---@param textBlock string
function TextBlockDelete(textBlock) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD0976CC34002DB57)  
---This native does not have an official description.
---@param textBlock string
---@return boolean
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3CF96E16265B7DC8)  
---This native does not have an official description.
---@param textBlock string
---@return boolean
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF66090013DE648D5)  
---This native does not have an official description.
---@param textBlock string
function TextBlockRequest(textBlock) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBE1067CD1C9570F6)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x51DE09A2196BD951)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6095358C4142932A)  
---id is the return value from 0xD9459157EB22C895.
---@param id integer
function UiPromptClearHorizontalOrientation(id) end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x51259AE5C72D4A1B)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF1622CE88A1946FB)  
---This native does not have an official description.
function UiPromptDisablePromptsThisFrame() end

---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFC094EF26DD153FA)  
---This native does not have an official description.
---@param p0 integer
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x06565032897BA861)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6A2F820452017EA2)  
---This native does not have an official description.
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCB73D7521E7103F0)  
---This native does not have an official description.
---@param p0 any
---@param p1 integer
---@return integer
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC65A45D4453C2627)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7D393C247FB9B431)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA0D1D79C6036A855)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD9459157EB22C895)  
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x876E4A35C73A6655)  
---TM_ANY = 0,
---TM_ON_FOOT,
---TM_IN_VEHICLE
---@param prompt integer
...
---**`HUD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB6857100F8FD433C)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
