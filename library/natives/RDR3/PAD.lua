...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCB0360EFEFB2580D)  
---nullsub, doesn't do anything
---@param control integer
function ClearControlLightEffect(control) end

---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA0CEFCEA390AAB9B)  
---Old name: _CLEAR_SUPPRESSED_PAD_RUMBLE
---@param control integer
function ClearControlShakeSuppressedId(control) end

---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5F4B6931816E599B)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD7D22F5592AED8BA)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x771DFCB24D19C2F6)  
---This native does not have an official description.
---@param control integer
---@return integer
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6CD79468A1E595C6)  
---This native does not have an official description.
---@param control integer
---@return boolean
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x77B612531280010D)  
---This native does not have an official description.
---@return boolean
function IsLookInverted() end

---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA571D46727E2B718)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1252C029FC8EBB4D)  
---_IS_R* - _IS_S*
---@return boolean
function N_0x1252c029fc8ebb4d() end

---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x43F35DDB2905D945)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x52C68E92D6E23ADD)  
---This native does not have an official description.
---@param p0 any
function N_0x52c68e92d6e23add(p0) end

---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5F217BC1190503D8)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x709BA8C08C5C008D)  
---This native does not have an official description.
function N_0x709ba8c08c5c008d() end

---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBD629C1C4F501C80)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2804658EB7D8A50B)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8290252FFF36ACB5)  
---nullsub, doesn't do anything
---
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA45884DB10EC7EE3)  
---nullsub, doesn't do anything
---@param control integer
---@param red integer
---@param green integer
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x48B3886C1358D0D5)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF239400E16C23E08)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x14D29BB12D47F68C)  
---nullsub, doesn't do anything
---@param control integer
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE8A25867FBA3B05E)  
...
---**`PAD` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x38C16A305E8CDC8D)  
