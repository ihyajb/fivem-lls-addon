...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0E3BDEED21BEB945)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x10827B5A0AAC56A7)  
---This native does not have an official description.
---@param player Player
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xECE3C34B270428D5)  
---Only used in rcm_homerob00 R* Script
---@return boolean
function AreAnyLawPedsInvestigating() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF0FBFB9AB15F7734)  
---This native does not have an official description.
---@param player Player
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA22C46F16359471C)  
---Only used in trainrobbery_ambient R* Script
---@return boolean
function AreLawPedsEnabledForTrain() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x69E181772886F48B)  
---This native does not have an official description.
---@param player Player
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0BB6DE7D23C60626)  
---This native does not have an official description.
---@param player Player
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC76F252371150D9A)  
---This native does not have an official description.
---@param player Player
function ClearBounty(player) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBCC6DC59E32A2BDC)  
---This native does not have an official description.
---@param player Player
function ClearPlayerPastCrimes(player) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x062B4A4A3396351D)  
---This native does not have an official description.
---@param player Player
function ClearWantedScore(player) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8F9DE75680275C9F)  
---This native does not have an official description.
---@param name string
function CreateGuardZone(name) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0D4B77E862475ED3)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x75CBF20BA47E4F89)  
---dispatchResponseHash: see common/data/dispatchresponses/..
---@param x number
---@param y number
---@param z number
---@param dispatchResponseHash Hash | string
---@return any
function CreateLawDispatchResponseForCoords(x, y, z, dispatchResponseHash) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x26D558692B25DD95)  
---This native does not have an official description.
---@param name string
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x710448D44A64C213)  
---This native does not have an official description.
---@param toggle boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x76CF93D4B416B288)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x35E5E21F9159849C)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x532C5FDDB986EE5C)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x717DA2281DF90855)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDD5FD601481F648B)  
---This native does not have an official description.
---@param player Player
---@return integer
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xAD401C63158ACBAA)  
---This native does not have an official description.
---@param player Player
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x00DB0BC05E3FAA4E)  
---This native does not have an official description.
---@param ped Ped
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x018F30D762E62DF8)  
---This native does not have an official description.
---@param ped Ped
---@return any, any p1
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x07E8B8B20570271C)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0BDFEBCF40A5F7E3)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0C392DB374655176)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0DBACA9C38C9A686)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0EAF918F751F27BA)  
---This native does not have an official description.
---@param ped Ped
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0F230DE0DDBE3649)  
---This native does not have an official description.
---@param player Player
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2001687F9562FD9D)  
---Only used in resapwn_dump_body R* Script
---@param p0 any
function N_0x2001687f9562fd9d(p0) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x21213B833EF4DAE7)  
---This native does not have an official description.
---@param player Player
---@param ped Ped
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x22741652985C84D0)  
---Used in SP only
---_REPORT_*
---@param player Player
---@param lawRegionHash Hash | string
function N_0x22741652985c84d0(player, lawRegionHash) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x26934083D3F2579C)  
---This native does not have an official description.
---@param player Player
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x292AD61A33A7A485)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x331D349E0380B097)  
---This native does not have an official description.
---@param p0 any
function N_0x331d349e0380b097(p0) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3738B784DDD35CC6)  
---This native does not have an official description.
---@param player Player
---@param p1 integer
---@param p2 integer
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3852237A3D9DF145)  
---This native does not have an official description.
---@param p0 integer
function N_0x3852237a3d9df145(p0) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x390710D2DAFA6BFF)  
---_CLEAR*
---@param player Player
---@param p1 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3D2674828A4E6B3C)  
---This native does not have an official description.
---@return boolean
function N_0x3d2674828a4e6b3c() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x40851BCC33ACD9AB)  
---This native does not have an official description.
---@param ped Ped
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x522F74636DF10201)  
---This native does not have an official description.
---@param player Player
---@param itemSet ItemSet
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5E6F375CA101C108)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x61B98367D93F012F)  
---This native does not have an official description.
---@param player Player
function N_0x61b98367d93f012f(player) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6ABC50979655BEE7)  
---This native does not have an official description.
---@param player Player
---@param p2 any
---@return Hash crimeType
function N_0x6abc50979655bee7(player, p2) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7351DA734F989F4E)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7FC667F6DDFBCDCC)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x82F11E1296996574)  
---Only used in rcm_gunslinger1_1 R* Script: p0 = 0
---@param p0 integer
function N_0x82f11e1296996574(p0) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x856CE8FDE2416602)  
---This native does not have an official description.
---@param ped Ped
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x89E005B1662F6E48)  
---This native does not have an official description.
---@param player Player
---@param p1 integer
---@param p2 integer
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x95878B13E272EF1F)  
---This native does not have an official description.
---@param entity Entity
---@param ped Ped
---@param p2 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9772395CC73E8D1F)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x987BE590FB9D41E5)  
---This native does not have an official description.
---@param p0 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9C5BD8C562565CE6)  
---This native does not have an official description.
---@return Hash crimeType
function N_0x9c5bd8c562565ce6() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9C8A2BF37E966464)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9D5C9A5A3321B128)  
---This native does not have an official description.
---@param player Player
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9EF07CFBB19A9733)  
---Only used in shoprobberies R* Scripts
---@return boolean
function N_0x9ef07cfbb19a9733() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB527099D1E1EED49)  
---This native does not have an official description.
---@param player Player
---@param p1 integer
---@return boolean, Hash crimeType
function N_0xb527099d1e1eed49(player, p1) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBD944A3D36E992DE)  
---Called together with REPORT_POLICE_SPOTTED_PLAYER
function N_0xbd944a3d36e992de() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC0DF161950FB101E)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC687A23E166DCF68)  
---This native does not have an official description.
---@return any, any p0
function N_0xc687a23e166dcf68() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC7DC5A0A7DF608CB)  
---_GET_DISPATCH_*
---@param flag integer
---@return boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCBFB4951F2E3934C)  
---This native does not have an official description.
---@param player Player
---@return any data
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD6C0A8C7C0B2F82C)  
---This native does not have an official description.
---@param player Player
---@param p1 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD7494DED50C6EF52)  
---Only used in R* SP Scripts
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDA1A9ADC4E3D4B16)  
---Only used in R* SP Scripts
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDAEFDFDB2AEECE37)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDCF12B89624AAC96)  
---This native does not have an official description.
---@param p0 boolean
function N_0xdcf12b89624aac96(p0) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDEA083C16BB91345)  
---This native does not have an official description.
function N_0xdea083c16bb91345() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE083BEDA81709891)  
---This native does not have an official description.
---@param player Player
---@return integer
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE4D6E45F491A66CB)  
---This native does not have an official description.
---@param player Player
---@param p1 integer
---@return any
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE94B5E938619712E)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE9AC8466ABE484BB)  
---Only used in R* SP Scripts
---Params: p1 = 0
---@param p0 boolean
---@param p1 any
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE9EB79CBF9C0F58A)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xEDFC6C1FD1C964F5)  
---_SET_C* - _SET_D*
---@param player Player
---@param crimeType Hash | string
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFFEBE5AA96BC2E4E)  
---This native does not have an official description.
---@param ped Ped
---@param crimeType Hash | string
---@param p2 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC08E804C91F47C80)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC61EDEBF16CD9668)  
---p0 is always BOUNTYHUNTERSGLOBALCOOLDOWN in R* scripts
---@param p0 Hash | string
---@param p1 boolean
---@param p2 any
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x67EBDD958835956C)  
---This native does not have an official description.
---@param name string
function RemoveGuardZone(name) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF60386770878A98F)  
---crimeType:
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9C4352134B2835FB)  
---This native does not have an official description.
---@param player Player
---@param dispatchResponseHash Hash | string
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2728C77FBC4B9796)  
---This native does not have an official description.
---@param player Player
function ResetWantedForNewIncident(player) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4B52BF96E225D230)  
---This native does not have an official description.
---@param toggle boolean
function SetAllowDisabledLawResponses(toggle) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x093A9D1F72DF0D19)  
---This native does not have an official description.
---@param player Player
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF19706B1F8FFA88F)  
---p0 is always BOUNTYHUNTERSGLOBALCOOLDOWN in R* scripts
---@param p0 Hash | string
---@param p1 integer
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x55F37F5F3F2475E1)  
---Force clears local player's wanted level
function SetBountyHunterPursuitCleared() end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDDCE8E960D1DE240)  
---This native does not have an official description.
---@param enable boolean
function SetCantLoseLawThisResponse(enable) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x009CF9A29972C298)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDE5FAA741A781F73)  
---This native does not have an official description.
---@param player Player
---@param p1 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x002BABE0B7D53136)  
---This native does not have an official description.
---@param multiplier number
function SetDispatchMultiplierOverride(multiplier) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7E7BF59F89FC6C6D)  
---This native does not have an official description.
---@param name string
---@param x number
---@param y number
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2F9005E2EA4E5EE4)  
---This native does not have an official description.
---@param name string
---@param x number
---@param y number
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA8A74AA79FB67159)  
---This native does not have an official description.
---@param name string
---@param volume Volume
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8C598A930F471938)  
---This native does not have an official description.
---@param name string
---@param volume Volume
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x35815F372D43E1E5)  
---This native does not have an official description.
---@param name string
---@param volume Volume
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA1B0E6301E2E02A6)  
---This native does not have an official description.
---@param name string
---@param volume Volume
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xAD3E07C37A7C1ADC)  
---This native does not have an official description.
---@param name string
---@param volume Volume
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9BBDCB8DF789EBC1)  
---This native does not have an official description.
---@param player Player
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4752F68EB7F2D280)  
...
---@param player Player
---@param lawRegionHash Hash | string
---@param stateHash Hash | string
function SetLawRegion(player, lawRegionHash, stateHash) end

---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFEC85339AACA2A35)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x819ADD5EF1742F47)  
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE0FA74AA3CCE650B)  
---This native does not have an official description.
---@param player Player
---@param lawRegionHash Hash | string
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x73BAD7B2F2DB50DE)  
---This native does not have an official description.
---@param player Player
---@param lawRegionHash Hash | string
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x362086B911657B1A)  
---This native does not have an official description.
---@param player Player
---@param p1 boolean
...
---**`LAW` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA80FF73F772ACF6A)  
---This native does not have an official description.
---@param player Player
