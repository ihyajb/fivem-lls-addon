...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4C221BAC54D735C3)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0EFC5DC62E67609B)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC239DBD9A57D2A71)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA3120A1385F17FF7)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE20A909D8C4A70F8)  
---Deletes a vehicle.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x877EA24EB1614495)  
--- Determines the interaction/storage state of a vehicle rear compartment or storage area.
---Returns whether the query was successful and writes a state value to outState
---Observed states:
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC29996A337BDD099)  
---This native does not have an official description.
---@param trackIndex integer
---@return boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x75DCED9EEC5769D7)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0E558D3A49D759D6)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x35D302397E524939)  
---This native does not have an official description.
---@param trackIndex integer
---@param x number
---@param y number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x52F45D033645181B)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6DE03BCC15E81710)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1A00961A1BE94E5E)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x61787DD28B8CC0D5)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBA958F68031DDBFC)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9CC94A948EAF5372)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x67995318F5FAA496)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1E8A921112891651)  
---This native does not have an official description.
---@param trackIndex integer
---@return vector3
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x42113B857E33C16E)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x90DBFFAC43B22081)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2701D01D5E18FC31)  
---This native does not have an official description.
---@return boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBA9325BE372AB6EA)  
---See REQUEST_VEHICLE_RECORDING
---@param recording integer
---@param script string
---@return boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1FF00DB43026B12F)  
---This native does not have an official description.
function InstantlyFillVehiclePopulation() end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5698BA4FD04D39C4)  
---This native does not have an official description.
---@param x number
---@param y number
---@param z number
...
---@param p5 boolean
---@return boolean
function IsSpawnPositionValidForTrain(trainConfig, x, y, z, direction, p5) end
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x78C3311A73135241)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1ABA9753939503C5)  
---VEH_STUCK_ON_ROOF = 0,
---VEH_STUCK_ON_SIDE,
---VEH_STUCK_HUNG_UP,
---VEH_STUCK_JAMMED
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x012701ED938B85DE)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0355FE37240E2C77)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0516FAE561276EFC)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0D5FDF0D36FA10CD)  
---This native does not have an official description.
---@param trackIndex integer
function N_0x0d5fdf0d36fa10cd(trackIndex) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0F7F603BDE08C4D3)  
---This native does not have an official description.
---@param p0 any
function N_0x0f7f603bde08c4d3(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x0FDDEE66E3465726)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x14DA8C4BC2CCD90A)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x15206E88FF7617DF)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x165BE2001E5E4B75)  
---This native does not have an official description.
---@param p0 any
function N_0x165be2001e5e4b75(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x16B86A49E072AA85)  
---This native does not have an official description.
function N_0x16b86a49e072aa85() end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x172E9DD35858DCD7)  
---This native does not have an official description.
---@param p0 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x23F66C36F8E5EAAB)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x27E3F2B57209FA54)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2BB2B5BCF0DF8008)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x2C46D2A591D8C322)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3053064F909B5F42)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3137EDC899E6DAE4)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x34BCF6209B9668A7)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x37D238BE69F7378A)  
---This native does not have an official description.
---@param trackIndex integer
---@return boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x38E7DD70A242D5CB)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 integer
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3D86997A86FEEF0D)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x41365DB586CD9E8E)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x485B05EF05B9AEE9)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4C05B42A8D937796)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x5AADC7BBBB1BCEEB)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x615B3B8E73634509)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x63509DDF102E08E8)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 integer
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6703872EC09BC158)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x68830738A6BFB370)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x697DF68F3A761A50)  
---This native does not have an official description.
---@param p0 any
function N_0x697df68f3a761a50(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6B34BE961F639E21)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 integer
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6C87F49BFA181DB5)  
---Returns trackIndex
---@param x number
---@param y number
---@param z number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6EA1273D525427F4)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6FD7BDF10304363A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x703D4FB366DA4452)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x718EB706B6E998A0)  
---This native does not have an official description.
---@param trackIndex integer
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x7408B5C66BA31ADB)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x750D42C013F64AE7)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8379E05871AD24E0)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x873AAF600CC36DAC)  
---This native does not have an official description.
---@param p0 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8878FF3EEE2868A9)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8DECD262602548B9)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x9868C0D0134855F7)  
---nullsub, doesn't do anything
---@param p0 any
function N_0x9868c0d0134855f7(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x98A7598C579EE871)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA230A5DDE12ED374)  
---This native does not have an official description.
---@param p0 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA7966807953A18EE)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xA9E185D498B9AC67)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB4241AD8F5AEE9ED)  
---This native does not have an official description.
---@param trackIndex integer
---@return boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB961DD799A837BD7)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC351394B932A6A50)  
---This native does not have an official description.
---@param p0 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCACAB2B123BBDBD6)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCAFF2C9747103C02)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCBC7B6F9A56B79F6)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xCEB1F1EED484A5B4)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD0116DF21E6C7B36)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@return any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD0AABE5B9F8FA589)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD0BA1853D76683C8)  
---This native does not have an official description.
---@param trackIndex integer
---@param x number
---@param y number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD1DF5E54F4ACBE1A)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD4907EF4334C7602)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD9BF3ED8EFB67EA3)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDC0556D0F484ECAA)  
---This native does not have an official description.
---@param p0 any
function N_0xdc0556d0f484ecaa(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDC69F6913CCA0B99)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xDD100CE1EBBF37E3)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE12F5ED49F44D40D)  
---This native does not have an official description.
---@param p0 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE682002DB1F30669)  
---This native does not have an official description.
---@param p0 any
function N_0xe682002db1f30669(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE777DDF3E78397E8)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE78993FF9022C064)  
---This native does not have an official description.
---@param p0 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF57DB8E83DCD8349)  
---This native does not have an official description.
---@param p0 any
---@return any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF5EA41C1408695FB)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF8F7DA13CFBD4532)  
---This native does not have an official description.
---@param trackIndex integer
---@param p1 boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFF2B1F59FB892F14)  
---This native does not have an official description.
---@param p0 any
function N_0xff2b1f59fb892f14(p0) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFFFE15B433300B8C)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC619A44639BC0CB4)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x745F15A215F2DDF1)  
---windowIndex:
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC474CF16EDA45DC9)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x138398153824E332)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x3D596E6E88A02C24)  
---This native does not have an official description.
function SetAllVehicleGeneratorsActive() end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xBBB134FB9D50C0CC)  
---This native does not have an official description.
---@param x1 number
---@param y1 number
---@param z1 number
...
---@param y number
---@param z number
function SetBalloonFaceDirectionThisFrame(vehicle, x, y, z) end
...
---@param y number
---@param z number
---@param autoDrive boolean
---@param speedMultiplier number
function SetBalloonRoute(vehicle, x, y, z, autoDrive, speedMultiplier) end
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE3261532550D6A9F)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xD4288603E8766FF7)  
---nullsub, doesn't do anything
---@param toggle boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x081FB9D6422F804C)  
---doorId: see SET_VEHICLE_DOOR_SHUT
---
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x73F1E4F6DF26FE30)  
---This native does not have an official description.
---@param p0 boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF5FFB08976911B50)  
---This native does not have an official description.
---@param p0 any
---@param p1 any
---@param p2 any
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xFEDFA97638D61D4A)  
---This native does not have an official description.
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xF44D446D4E36DB87)  
---This native does not have an official description.
---@param toggle boolean
function SetRandomBoats(toggle) end

---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1156C6EE7E82A98A)  
---This native does not have an official description.
---@param toggle boolean
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xE6BD7DD3FD474415)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x1D7678F81452BB41)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x606374EBFC27B133)  
---This native does not have an official description.
---@param multiplier number
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x6A3C24B91FD0EA09)  
---doorId: enum eDoorId
---{
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x8BDC5B998B4654EF)  
---1000 is max health
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB64CFA14CB9A2E78)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xC6B9BF123B9463B6)  
---index: 0 - 1
---
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x84DAAE11E9EE4FC3)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0x4932B84E3276508E)  
...
---**`VEHICLE` `client`**  
---[Native Documentation](https://rdr3natives.com/?native=0xB4E3BFC39CA16057)  
